class SenchaApp < Padrino::Application
  register Padrino::Mailer
  register Padrino::Helpers

  register Barista::Integration::Sinatra unless Settings.package_assets
  use Rack::ForceDomain, Settings.force_domain if Settings.force_domain.present?

  set :session_secret, "64a16026f5e34be236a433dc490eca8a4393b543c8b0021342ef50ae6c2857f4"
